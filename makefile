...
OBJS = boot.o kernel.o vesa.o interrupts.o pic.o interrupts_asm.o tss.o gdt.o gdt_asm.o keyboard.o shell.o string.o snakegame.o timer.o rmfs.o notepad.o
ISO = vortexos.iso
